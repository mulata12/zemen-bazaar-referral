  ...
  if (!role || role.toUpperCase() !== "ADMIN") {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <p className="text-gray-700 text-lg">Access denied — Admins only.</p>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          <div className="xl:col-span-2 space-y-8">
            {activeTab === "config" && (
              <ProgramConfiguration config={adminData.programConfig || {}} onUpdate={updateProgramConfig} />
            )}
            {activeTab === "tracking" && <ReferralTracking referrals={adminData.referral || []} />}
